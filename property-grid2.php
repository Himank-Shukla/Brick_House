        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-2">
            <div class="form-group">
              ...
              <select class="form-control form-control-lg form-control-a" id="Type" name="type" onchange="">
		 ...
		 <option value="Villa">Villa</option>
          ...
          <div class="col-md-6 mb-2">
            <div class="form-group">
              ...
              <select class="form-control form-control-lg form-control-a" id="city" name="city" onchange="">
          ...
          <div class="col-md-6 mb-2">
            <div class="form-group">
              ...
              <select class="form-control form-control-lg form-control-a" id="bedrooms" name="bhk" onchange="">
                <option>Any</option>
            ...
            <div class="grid-option">
			  ...
			  <?php 
			       ...
			       $city=null; $bhk=null;
					...
					if(isset($_GET["city"],$_GET["bhk"])){
						$city=$_GET["city"];
						$bhk=$_GET["bhk"];
					//	//echo "city:".$city;
					}
					if($city==null or $bhk==null){
...
">
        ...
        ?>
			  	<?php   echo'
					...
					$queryx=mysqli_query($conn,"SELECT property_id from property where property_id in (select property_id from property_type where bhk='$bhk')")or die(mysqli_error($conn));
					//print_r($queryx);
